...
class Episode(models.Model):
	...
	video_host			= models.CharField(max_length=250, blank=True, default='')
...
class Series_detail(models.Model):
	series = models.ForeignKey(Serie, on_delete=models.CASCADE, blank=True)
...
class Movie(models.Model):
	...
	folder_id 			= models.CharField(max_length=50, blank=True)
	video_host			= models.CharField(max_length=250, blank=True, default='')
	video_src 			= models.CharField(max_length=250, blank=True)
	
	class Meta:
		indexes = [models.Index(fields=['movie_name'])]
		ordering = ['id']
